...
public class GestisciContratto {
	 ...
	 * In particolare, se cb � diverso da null: chiude tutti i contratti la cui data di inizio
	 ...
	 *  l'operatore che proceder� con le procedure del caso.
	 */
	 ...
	 * @return true se il contratto � stato stipulato correttamente; false altrimenti
	 */
	 ...
	 * @return true se il contratto � stato modificato correttamente; false altrimenti
	 */
	 ...
	 * @return true se il contratto � stato annullato correttamente; false altrimenti
	 */
	 ...
	 * @param id di tipo String: indica l'id del contratto, la cui relativa auto �
	 * stata correttamente ritirata
	 * @return true se l'impostazione dell'avvenuto ritiro � avvenuta correttamente; 
	 * false altrimenti
	 */
