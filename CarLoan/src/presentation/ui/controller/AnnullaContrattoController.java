	...
	public void conferma(){
		...
		if(!id.getText().isEmpty()){
			...
			if(datiContratto.isEmpty())
				v.showMessage(1, "Errore!" ,"Nessun contratto ritrovato con tale id. "
				...
				Optional<ButtonType> confirm =  v.showMessage(2, "Attenzione", 
						"Le modifiche saranno permanenti, si è sicuri di voler continuare?");
				...
				if(confirm.isPresent() && confirm.get() == ButtonType.OK){
					...
					if((boolean)fc.handleRequest("AnnullaContratto",parameters)){
						...
						v.showMessage(1, "Errore", "C'è stato un errore nell'operazione. Riprova.");
					}
