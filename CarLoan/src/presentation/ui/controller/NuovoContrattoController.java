...
public class NuovoContrattoController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if(GestioneSessione.getDitta()==null) {
			...
			ArrayList<String> città = (ArrayList<String>)(fc.handleRequest("GetCitt�Restituzione"));
			if(! città.isEmpty())  {
				sede.setItems(FXCollections.observableArrayList(città));
				GestioneSessione.setDitta(città);
			}
			else
